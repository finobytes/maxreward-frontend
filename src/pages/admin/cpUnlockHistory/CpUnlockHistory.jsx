...
import { useCpUnlockHistoryAdmin } from "../../../redux/features/admin/cpUnlockHistory/useCpUnlockHistoryAdmin";
...
const CpUnlockHistory = () => {
  ...
  return (
    <div>
      <PageBreadcrumb
        items={[{ label: "Home", to: "/admin" }, { label: "CP Unlock History" }]}
      />
                ...
                unlockHistories.map((item, idx) => {
                  return (
                    <TableRow key={item?.id}>
                      ...
                      <TableCell className="text-center">
                        <Link
                          to={`/admin/cp-unlock-history/${item?.id}`}
