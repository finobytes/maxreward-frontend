  ...
  return (
    <div className="bg-white shadow-md rounded-2xl p-4">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        {/* Title */}
        <h3 className="text-lg font-semibold text-gray-800">All Member List</h3>
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full md:w-auto">
          ...
          <form className="relative flex-1 sm:flex-none">
            ...
            <input
              ...
              className="h-11 w-full rounded-lg border border-gray-200 bg-transparent py-2.5 pl-12 pr-10 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:ring-2 focus:ring-brand-500/20 focus:outline-none"
            />
            <button
              type="button"
          ...
          <div className="relative">
            <select
              ...
              name="sort"
              defaultValue="Status"
              className="appearance-none rounded-md bg-brand-600 text-white py-2 pl-3 pr-8 text-sm focus:outline-none focus:ring-2 focus:ring-brand-600"
            >
        ...
        <table className="w-full text-sm text-left text-gray-500">
          <thead className="text-xs text-gray-700 uppercase bg-gray-50">
            <tr>
              ...
              <th className="px-6 py-3">Purchased (RM)</th>
          ...
          <tbody>
            <tr className="bg-white border-b hover:bg-gray-50 transition">
              ...
              <td className="px-6 py-4">4938</td>
