...
import { useGender } from "../../../../redux/features/admin/gender/useGender";
...
import {
  ...
  setPerPage,
  resetFilters,
} from "../../../../redux/features/admin/gender/genderSlice";
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
const Gender = () => {
  ...
  const { search, per_page } = useSelector((s) => s.gender);
    ...
    <div>
      ...
      <div className="rounded-xl border bg-white p-4 relative">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <HasPermission required="admin.e-commerce.gender.create">
                  ...
                  <TableRow key={item.id}>
                    ...
                    <TableCell>
                      <div className="flex gap-2">
                        <HasPermission required="admin.e-commerce.gender.edit">
                          <button
                        ...
                        <HasPermission required="admin.e-commerce.gender.delete">
                          <button
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>
              {editId ? "Edit Gender" : "Create Gender"}
            </DialogTitle>
          </DialogHeader>

          <form onSubmit={submitForm} className="space-y-4 mt-3">
            <div>
              <label className="text-sm font-medium">Gender Name</label>
              <InputField
                type="text"
                value={formData.name}
                required
        ...
        <DialogContent>
          <DialogHeader>
            <div className="flex flex-col items-center">
              ...
              <DialogTitle className="text-xl mt-2">Delete Gender</DialogTitle>
              <DialogDescription className="text-center mt-2">
                Are you sure you want to delete this gender? This action is
