...
import { useModel } from "../../../../redux/features/admin/model/useModel";
...
import {
  ...
  setPerPage,
  resetFilters,
} from "../../../../redux/features/admin/model/modelSlice";
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
const Model = () => {
  ...
  const { search, per_page } = useSelector((s) => s.model);
  ...
  const submitForm = async (e) => {
    ...
    try {
      ...
      toast.success(
        editId ? "Model updated successfully!" : "Model created successfully!",
      );
        ...
        <DialogContent>
          <DialogHeader>
            <div className="flex flex-col items-center">
              ...
              <DialogTitle className="text-xl mt-2">Delete Model</DialogTitle>
